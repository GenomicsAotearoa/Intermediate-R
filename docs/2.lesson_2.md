...
??? success "Solutions"
    ...
    === "Method 2"
        ...
        Use a nested list by designating one of the vectors to be a level above the other. This is most intuitive to me and does not require additional counters and is flexible for further list-based manipulation as required. If data need to be in the form of a 1 dimensional vector, simply `unlist()`.
    ...
    === "Method 3"
        ...
        # Append vector column-wise
        as.vector(output)

        # Append vector row-wise
        as.vector(t(output))
        ```
