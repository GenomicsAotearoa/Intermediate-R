...
>     * `fn_name` with no `()` sometimes shows the underlying code
> * Translate code from other languages
>     * Coding languages, like human languages, carry a certain philosophy. Learn from other branches of coding philosophy to "see" things differently.
> * Be very flexible when test writing functions for interactive use; apply military discipline for functions deployed for programmatic purposes.
> * Break your functions
>     * Test possible outcomes
>     * Make purposefully ridiculous mistakes so you know how it might respond (error, warning, outputs)
>     * Understand side effects and possible places it might give nonsense results
> * Benchmark your functions
>     * How long does it take to run?
>     * Does it get stuck somewhere?
>     * Is some parts of the code inefficient?
