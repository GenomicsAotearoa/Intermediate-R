...
!!! note "Predicate and predicate functions"
    ...
    A predicate is a statement or function that evaluates and returns **one** `TRUE` or `FALSE` value. For example, this is a predicate that evaluates if `x` is larger than 5:
...
=== "Binary outcomes" 
    ...
    !!! r-project "code"
        ...
        ??? success "Output"
            ...
            ```r linenums="1"
            [1] "BANANA is a fruit"      "APPLE is a fruit"       "kale is not a fruit"    "DURIAN is a fruit"     
            [5] "PEAR is a fruit"        "spinach is not a fruit"
            ```
...
=== "Multiple conditions and outcomes" 
    ...
    !!! r-project "code"
        ...
        ```r linenums="1"
        fridge <- c("cheddar", "yoghurt", "kiwifruit", "spinach", "olive oil", "mozzarella")
        dairy <- c("cheddar", "yoghurt", "mozzarella")
        fruits <- c("apple", "banana", "kiwifruit")
        vegetables <- c("spinach", "kale", "broccoli")

        case_when(
        fridge %in% dairy ~ str_c(fridge, " is a dairy product"),
        fridge %in% fruits ~ str_c(fridge, " is a fruit"),
        fridge %in% vegetables ~ str_c(fridge, " is a vegetable"),
        .default = str_glue("{fridge} doesn't fit a category!")
        )
        ```
        ...
        ??? success "Output"
            ...
            olive oil doesn't fit a category!
            mozzarella is a dairy product
            ```
...
- Reach their minima when one taxa is dominant
